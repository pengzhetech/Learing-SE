...
public class NumberUtil {
    ...
    public static void main(String[] args) {
        System.out.println(bigDecimal2chineseNum(BigDecimal.valueOf(12345_5678_9098_7654L))); // 一万二千三百四十五亿五千六百七十八万九千零九十八亿七千六百五十四
        System.out.println(bigDecimal2chineseNum(BigDecimal.valueOf(1000_0000_0000_0002L)));
    }
